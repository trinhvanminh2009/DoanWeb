...
$test1=new UserDb();
$userAlbum=$test1->getUserByUN("$username");
?>
    ...
    <div class="container" >
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a  id ="btnPopoverAlbum" title="<h4>Labdien, Ways of love</h1> Now you know how to greet people in Latvian"  data-placement="bottom" data-content="
                    <div id='myProgress' style='width: 250px;background-color: #ddd'>
                        ...
                        <?php
                        echo '<img src="data:image/jpeg;base64,'.base64_encode($userAlbum->getAvatar()) .'" class="img-circle" alt="Cinque Terre" width="40" height="40" style="margin-left: 15px"/>';
                        ?>
                    </a>
