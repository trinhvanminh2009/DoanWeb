...
(function($) {
	...
	FBPhotoBox.prototype = {
		...
		initDOM: function() {
			var html = ['<div class="fbphotobox-main-container" style="margin-top: 5%">',
							'<div class="fbphotobox-container-left" style="margin-top: 5%">',
		...
		refreshBoxSize: function(image) {
			...
			var imageWidth = image.width*90/100;
			var imageHeight = image.height*90/100;
			...
			if (imageHeight < maxHeight) {
				leftContainer.height(imageHeight+150);
				this.fbpMainImage.css("max-height",imageHeight+150);
			}
			else {
				leftContainer.height(maxHeight+150);
				this.fbpMainImage.css("max-height",maxHeight+150);
			}
			...
			rightContainer.css("height", 700);
			$(".fbphotobox-image-content").css("height", 665);

			this.fbpMainContainer.css({
				width: (leftContainer.width() + rightContainer.width()+10),
				height: (leftContainer.height() +rightContainer.height+200)
			});
			if (isShow) {
